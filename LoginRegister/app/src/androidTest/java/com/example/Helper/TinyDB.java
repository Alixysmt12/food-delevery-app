...
public class TinyDB {
    ...
    public Example getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString( key );
        Example playerList = new Example();

            for (String jObjString : objStrings) {
                Example player = gson.fromJson( jObjString, Example.class );
    ...
    public void putListObject(String key, Example[] playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Example player: playerList){
